...
<section class="content">
	...
	<div class="col-md-12">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">Uanggah DAKUNG Persiapan</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<table class='table table-bordered'>
					...
					<tr>
                        ...
                        <input type="hidden" id="kegiatan" name="kegiatan" value="1">
                        <span><dt>Persiapan Rekomjak</dt></span> </td></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('persiapan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>persiapan/filenya/1", "type": "POST"},
                    columns: [
                        {
                            "data": "id_dakung",
                            "orderable": false
			...
			$(document).ready(function() {
                ...
                var t = $("#mytablea").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>persiapan/timnya", "type": "POST"},
                    columns: [
                        {
