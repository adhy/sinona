		...
		<div class="box box-warning box-solid">
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Kegiatan</td><td><?php echo cmb_di('kegiatan', 't_jenis_kegiatan', 'nama_kegiatan','id_jenis_kegiatan','','', 'Masukan kegiatan ...') ?> <?php echo form_error('kegiatan') ?></td>
					</tr>
        ...
        <script type="text/javascript">
			...
			$(document).ready(function() {
                ...
                var t = $("#mytablea").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>dakungall/timnya", "type": "POST"},
                    columns: [
                        {
