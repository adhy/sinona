			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<table class='table table-bordered'>
					...
					<tr>
                        ...
                        <input type="hidden" id="kegiatan" name="kegiatan" value="2">
                        <span><dt>Pelaksanaan Rekomjak</dt></span> </td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('pelaksanaan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>pelaksanaan/filenya/2", "type": "POST"},
                    columns: [
                        {
                            "data": "id_dakung",
                            "orderable": false
			...
			$(document).ready(function() {
                ...
                var t = $("#mytablea").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url()?>pelaksanaan/timnya", "type": "POST"},
                    columns: [
                        {
